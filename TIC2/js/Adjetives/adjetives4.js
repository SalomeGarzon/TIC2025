document.addEventListener("DOMContentLoaded", function () {
  ...
  function showResults(correctCount, incorrectCount) {
    ...
    feedbackContainer.innerHTML = `
      ...
      <button id="finishBtn" tabindex="0">Finish Game</button>
    `;

    // Agregar funcionalidades a los botones
    document.getElementById("retryBtn").addEventListener("click", retryLevel);
    document.getElementById("finishBtn").addEventListener("click", goToNextLevel);
  }
  ...
  function goToNextLevel() {
    window.location.href = "TIC2/html/Adjetives/adjetives1.html";
  }
